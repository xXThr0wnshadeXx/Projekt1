...
try {
 const app=await createApplication({openStorage:openPostgresStorage,retrieveAndNormalize:createGoogleContactsRetriever(),search:{goals:new EvidenceBackedGoalResolver(),engine:new BoundedRouteSearch()}});
