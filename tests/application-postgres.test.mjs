...
test('real startup storage applies 001 then 002 and can probe', {skip:!process.env.STORAGE_TEST_DATABASE_URL},async()=>{
 ...
 try{
  ...
  assert.deepEqual(applied.rows.map(r=>r.id),['001_private_storage','002_contacts_grants']);
