...
test('real startup storage applies 001 then 002 then 003 and can probe', {skip:!process.env.STORAGE_TEST_DATABASE_URL},async()=>{
 ...
 try{
  ...
  assert.deepEqual(applied.rows.map(r=>r.id),['001_private_storage','002_contacts_grants','003_fact_reviews','004_public_fact_staging','005_discovery_receipts','006_public_claim_decisions','007_discovery_staging']);
