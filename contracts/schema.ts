...
export const searchRequest = object({scopeId:id,expectedGraphVersion:id,goalText:string,k:optional(integer),maxHops:optional(integer),startPersonId:optional(id)});
