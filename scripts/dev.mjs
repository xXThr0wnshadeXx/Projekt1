...
import { browserEnvironment } from './private-env.mjs';
...
const children=[spawn(process.execPath,['dist/packages/server/main.js'],{stdio:'inherit',env}),spawn(process.execPath,['node_modules/vite/bin/vite.js'],{stdio:'inherit',env:browserEnvironment(env)})];
let closing=false;
