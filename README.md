...
2. Open your brief and copy its agent kickoff prompt:
   - [Nicholas — frontend and graph animation](docs/team/NICHOLAS.md)
...
This handoff contains plans and TypeScript contracts, not a runnable application. Nicholas and Shaw's ongoing local work must be inventoried and preserved. The earlier local fictional prototype is not the shared baseline.
