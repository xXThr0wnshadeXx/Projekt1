...
export class NetworkGraph {
  ...
  paint(now){
    ...
    for(const label of this.groupLabels){ctx.font=`${14/this.scale}px "Space Grotesk",sans-serif`;ctx.textAlign="center";ctx.fillStyle="#d3d0c0";ctx.fillText(`${label.name} · ${label.count}`,label.x,label.y);}
